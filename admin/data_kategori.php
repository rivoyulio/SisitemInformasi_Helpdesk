...
<div class="container-fluid">
	...
	<div class="row mt-4">
		<div class="col">
			...
			<a href="index.php?p=data_kategori" class="btn btn-outline-warning active mx-3 px-3">Data Kategori Masalah</a>
			...
			<table class="table table-bordered">
				...
				<tr class="bg-light">
				 ...
				 <?php
			        ...
			        $no=1;
			        $query    =mysqli_query($koneksi, "select * from kategori_masalah left join bagian on kategori_masalah.id_bagian = bagian.id_bagian where kategori_masalah.id_bagian");
				...
				<tr>
					...
					<td class="text-center">
						<a href="delete_kategori.php?id_kategori_masalah=<?= $data['id_kategori_masalah']?>" onclick="return confirm('Yakin mau hapus?')" class="btn btn-danger">
							Hapus Data
						</a>
					</td>
				</tr>
